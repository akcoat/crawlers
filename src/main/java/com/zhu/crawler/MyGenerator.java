...
public class MyGenerator {
    ...
    private static String packageName="com.zhu.crawler";  //模块名称
    private static String modelName="Persist";    //模块名称
    private static String authorName="zjw";     //作者
    private static String[] includeTableNames=new String[] { "tv" }; //需要生成的表名字
...
//        oracle=======
        ...
        dsc.setUsername("root");
        dsc.setPassword("root");
        dsc.setUrl("jdbc:mysql://127.0.0.1:3306/crawler?characterEncoding=utf-8&autoReconnect=true&failOverReadOnly=false");
